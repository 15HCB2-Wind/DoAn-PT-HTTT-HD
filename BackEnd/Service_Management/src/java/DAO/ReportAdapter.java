...
public class ReportAdapter {
    ...
    public static Object getAllCowOfCompany(ReportRequest request) {
        return HibernateUtil.getListSQL("call service_management_drinksmile.tkSoLuongBo_AllAgencies(:p0, :p1, :p2)", new Object[]{request.ngaybatdau,request.ngayketthuc,request.dachet });
    }
}
